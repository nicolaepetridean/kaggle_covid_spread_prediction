...
class BaseTrainer:
    ...
    def save_networks(self, saveIdx):
        ...
        for name in self.__modelNames:
            ...
            saveFile = os.path.join(saveName,'%s_model_%s.pth' % (saveIdx, name))
    ...
    def load_networks(self, saveIdx):
        ...
        for name in self.__modelNames:
            ...
            loadFile = os.path.join(loadName, '%s_model_%s.pth' % (saveIdx, name))
    ...
    def save_optimizers(self, saveIdx):
        ...
        for i, name in enumerate(self.__optimizerNames):
            ...
            saveFile = os.path.join(saveName,'%s_optimizer_%s.pth' % (saveIdx, name))
    ...
    def load_optimizers(self, saveIdx):
        ...
        for i, name in enumerate(self.__optimizerNames):
            ...
            loadFile = os.path.join(loadName, '%s_optimizer_%s.pth' % (saveIdx, name))
